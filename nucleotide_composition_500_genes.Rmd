---
title: "Nucleotide Composition Analysis for the 500 Most Expressed Genes"
...
seqs.5.ends.edge <- grep("seqs_5_ends_edge", 
                         dir("/data/sadhana/rnaseq_bias/fastas/500_genes", full.names = TRUE), 
                         value = TRUE)
...
### 5' read ends for 500 most expressed genes
...
### 3' read ends for 500 most expressed genes
...
ggsave("blocks_logos_500.png", blocks.logos, width = 24, height = 10, dpi = "retina")
...
ggsave("5_edge_logos_500.png", edge.5.logos, width = 24, height = 10, dpi = "retina")
...
ggsave("3_edge_logos_500.png", edge.3.logos, width = 24, height = 10, dpi = "retina")
```
